...
Shader "Shader Forge/Waterfall" {
    Properties {
        ...
        _Tesellation ("Tesellation", Range(0, 10)) = 10
        _OffsetMag ("OffsetMag", Range(0, 1)) = 0.3259
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_4539 = (o.uv0+node_7384.r*float2(0,1));
                float4 _OffsetNoise_var = tex2Dlod(_OffsetNoise,float4(TRANSFORM_TEX(node_4539, _OffsetNoise),0.0,0));
                float3 Offset = (float3(node_6890,_OffsetNoise_var.g,node_6890)*_OffsetMag);
                v.vertex.xyz += Offset;
...
////// Lighting:
                ...
                float3 node_4387 = lerp(lerp(_Dark1.rgb,_Dark2.rgb,i.uv0.g),lerp(_Light1.rgb,_Light2.rgb,i.uv0.g),floor(_NoiseMap_var.rgb * _Steps) / (_Steps - 1));
                float3 finalColor = node_4387;
